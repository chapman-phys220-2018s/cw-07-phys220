...
def plots(x,f,i,title,z=2):
    ...
    plt.plot(x, approx0, color = "red", label="approx., n=0")
    plt.plot(x, approx1, color = "orange", label="approx.,n=1")
    plt.plot(x, approx2, color = "yellow", label="approx.,n=2")
    plt.plot(x, approx3, color = "green", label = "approx.,n=3")
    plt.plot(x, approx4, color = "blue", label = "approx.,n=4")
    plt.plot(x, approx5, color = "purple", label = "approx.,n=5")
